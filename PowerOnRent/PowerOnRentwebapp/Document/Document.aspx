<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Document.aspx.cs" Inherits="PowerOnRentwebapp.Document.Document" %>
                        ...
                        <div id="divDocument">
                            <table class="tableForm">
                                <tr>
                                    ...
                                    :
                                    <td style="text-align: left">
                                        <asp:TextBox ID="txtDocTitle" runat="server" MaxLength="50" onchange="CheckDocumentTitle(this);"
                                            ValidationGroup="DocumentValidation" Width="250px" onkeypress="return IsAlphaNumeric(event);" ondrop="return false;"
