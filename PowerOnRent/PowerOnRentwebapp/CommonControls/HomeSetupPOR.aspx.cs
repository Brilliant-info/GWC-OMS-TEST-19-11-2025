    ...
    public partial class HomeSetupPOR : System.Web.UI.Page
    {
        ...
        private void loadstring()
        {
            try
            {
                ...
                lblrcode.Text= rm.GetString("ReasonCode", ci);
                lblvirtualsku.Text = rm.GetString("ImportVirtualSKU", ci);
                lblvirtualstock.Text = rm.GetString("ImportVirtualStock", ci);
                lblstockconfig.Text = rm.GetString("DatabaseSetting", ci);


            }
            catch(Exception ex)
            {
                Login.Profile.ErrorHandling(ex, "HomeSetupPOR.aspx", "Loadstring");
            }
