<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM2.Master" AutoEventWireup="true" CodeBehind="LocationList.aspx.cs" Theme="Blue" Inherits="PowerOnRentwebapp.UserManagement.LocationList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <table>
                                <tr>
                                   ...
                                   <td style="text-align: right; padding-left:15px;">
                                        <asp:Label ID="lblselectall" CssClass="headerText" runat="server" Text="Select All"></asp:Label> :
                                        <asp:CheckBox ID="ChkAllLocation" runat="server" OnClick="SelectAllLocation()" ControlsToDisable="" ControlsToEnable="" FolderStyle="" ParentCheckBoxID="" State="Unchecked" /> 
                                  </td>
                                </tr>
                            </table>
                        </td>
    ...
    <script type="text/javascript">
        ...
        function selectedRec() {
            ...
            if (document.getElementById("<%=ChkAllLocation.ClientID %>").checked == true) {
                var userid = document.getElementById("<%=hdnuserid.ClientID %>").value;
                PageMethods.SaveAllLocation(userid,SaveAllLoc_Success, SaveAllLoc_Fail)
            }
            else {
        ...
        function SaveAllLoc_Success()
        {
            window.opener.Grid1.refresh();
            self.close();
        }
        function SaveAllLoc_Fail() { alert("error"); }
