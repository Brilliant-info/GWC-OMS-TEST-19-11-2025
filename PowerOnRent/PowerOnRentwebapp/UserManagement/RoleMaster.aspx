                                                    ...
                                                    <obout:Grid ID="GridRoleMaster" runat="server" AutoGenerateColumns="false" AllowAddingRecords="false"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <obout:Column DataField="RoleName" HeaderText="Role Name" Width="15%" HeaderAlign="Left"
                                                             ...
                                                             <obout:Column DataField="UserType" HeaderText="User Type" Width="15%" HeaderAlign="Left"
                                                                Align="Left">
                                                            </obout:Column>
                                ...
                                <ContentTemplate>
                                    <center>
                                        <table class="tableForm" border="0">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlcompany" runat="server" ValidationGroup="Save" Width="187px"
                                                        DataTextField="Name" DataValueField="ID" onchange="GetCompany(this); GetDepartmentnew()">   <%--BindDepartment(this)--%>
                                                    </asp:DropDownList>
                                                ...
                                                <td colspan="3" style="text-align: left;">
                                                    <asp:DropDownList ID="ddlDeartment" runat="server" ValidationGroup="Save" DataTextField="Territory"
                                                        DataValueField="ID" Width="187px" onchange="GetDepartment(this)" ClientIDMode="Static">
                                                    </asp:DropDownList>
                                                    <%--
                                                    ...
                                                    <asp:DropDownList ID="ddlDesignation" runat="server" DataValueField="ID" DataTextField="Name"
                                                        ValidationGroup="Save" Width="250px" Visible="false">
                                                    </asp:DropDownList>
                                            ...
                                            <tr>
                                                <td>
                                                    <req><asp:Label Id="lblUserType" runat="server" Text="User Type"/></req>
                                                    :
                                                </td>
                                                <td style="text-align: left;">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RFVUserType" runat="server" ErrorMessage="Select UserType"
                                                        ControlToValidate="ddlUserType" InitialValue="0" Display="None" ValidationGroup="Save"></asp:RequiredFieldValidator>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:TextBox runat="server" ID="txtRoleName" MaxLength="100" Width="180px" onKeyPress="return alpha(this,event);"></asp:TextBox>
