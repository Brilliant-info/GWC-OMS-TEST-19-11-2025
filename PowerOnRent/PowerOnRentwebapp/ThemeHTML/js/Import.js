...
//var wmsApiPathimp = 'http://localhost:50068/api/Dev/v1/';
var wmsApiPathimp = "https://testoms.gwclogistics.com/GWCTESTRMSWEBAPI/api/Dev/v1/";

var importObject = "";
var templateId = '0';
var getCustomerId = 0; //$("#ddlcustomer").val(); // 1;// $("#ddlcustomer").val();
var getCompanyID = $('#hdnCompanyIdimp').val();  //mBrillWmsSession.getCompanyId(); //1;// $('#hdnCompanyID').val();
var getUserId = $('#hdnUserIDimp').val(); //mBrillWmsSession.getUserId(); //1; // $('#hdnUser').val();
...
function setUserIdCompanyid() {    getCompanyID = $('#hdnCompanyIdimp').val();    getUserId = $('#hdnUserIDimp').val();}
...
function initImport() {
    ...
    // DEFAULT JUMP TO IMPORT PAGE
    importObject = 'RMS Import';
    $("#import_wizard_steps").show();
    $("#import_wizard_grid").hide();
    Loadimporttemplate();
    initWmsImport();
...
function initWmsImport() {
    ...
    $(".WmsImport_Type").click(function () {
        ...
        var CustomerId = 0;// $('#ddlcustomer').val();
...
function sendDataToService() {
    ...
    if (extractCell != '') {
       ...
       // var wmsapipathimport = 'http://localhost:50068/api/staging/v1/';
        //var wmsapipathimport = 'http://localhost:50068/api/Dev/v1/';
        //var wmsapipathimport = 'http://localhost:50068/api/Dev/v1/';
		var wmsapipathimport = "https://testoms.gwclogistics.com/GWCTESTRMSWEBAPI/api/Dev/v1/";
...
function downloadTemplate(tmpltype) {
    ...
    debugger;
   // var wmslocalimp = "http://localhost:50068/api/staging/v1/";
   // var apiPath = wmslocalimp + 'generateimpTemplate';
    ...
    if (templateId != '0') {
        callHttpUrl(apiPath, postData, function (data) {
            ...
            if (getStatus == "success") {
               ...
               // var pathexc = "http://localhost:50068/ImportDesign/ImportTemplate/" + getImportfilepath;

              //  var wmsapipathimport = 'http://localhost:50068/api/Dev/v1/';
				var pathexc = "https://testoms.gwclogistics.com/GWCTESTRMSWEBAPI/ImportDesign/ImportTemplate/" + getImportfilepath;
				
				//var wmsApiPath = "https://testoms.gwclogistics.com/GWCRMSWEBAPI/api/Dev/v1/";

                //  var pathexc =  "http://164.68.123.40/download/" + getImportfilepath;
                 window.open(pathexc,'self');
...
function cancleImport() {
    ...
    window.location.href = '../RMS/ReturnOrder.aspx';
...
function FinishImport() {
    ...
    var url = "";
    if (getImportObjectName == 'RMS Import') {
...
function OpenInstruction() {    $("#wms-srv-Instruction-popup").show();    $("#wms-srv-Instruction-popup-close").click(function () {        $("#wms-srv-Instruction-popup").off();        $("#wms-srv-Instruction-popup").hide();    });}
/* TEXT COLUMN DEFINER CONTROL */
