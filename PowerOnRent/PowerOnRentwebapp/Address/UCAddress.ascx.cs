...
namespace PowerOnRentwebapp.Address
{
    public partial class UCAddress : System.Web.UI.UserControl
    {
        ...
        public static void ClearAddress(string ObjectName, string sessionID)
        {
            CustomProfile profile = CustomProfile.GetProfile();
            iAddressInfoClient AddressClient = new iAddressInfoClient();
            AddressClient.ClearTempDataFromDB(sessionID, profile.Personal.UserID.ToString(), ObjectName, profile.DBConnection._constr);
            AddressClient.Close();
        }
        ...
        public void ClearAddress(string ObjectName)
        {
            ...
            AddressClient.ClearTempDataFromDB(Session.SessionID, profile.Personal.UserID.ToString(), ObjectName, profile.DBConnection._constr);
            AddressClient.Close();
        }
