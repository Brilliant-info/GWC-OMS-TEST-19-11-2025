...
<body>
            ...
            <table class="gridFrame" style="margin: 2px 2px 2px 2px; width: 970px">
                <tr>
                    <td style="text-align: left;">
                        <asp:Label class="headerText" ID="lblAddressFormHeader" runat="server" Text="Add New Address Info"></asp:Label>
                    </td>
                    <td style="width: 20%">
                        <table style="float: right;">
                            <tr>
                                <td>
                                    <input type="button" id="btnAddressSubmit" runat="server" value="Submit" onclick="SubmitAddress();"
                                        style="width: 70px;" />
                                </td>
                                <td>
                                    <input type="button" id="btnAddressClear" runat="server" value="Clear" onclick="ClearAddress()"
                                        style="width: 70px;" />
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="tableForm" style="border: none; width: 970px">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br />
                                    <span class="watermark"><asp:Label Id="lblcharremain" runat="server" Text="characters remaining
                                    out of 100"/><span id="CharactersCounter1">100</span> </span>
                                ...
                                <td>
                                    ...
                                    <br />
                                    <span class="watermark"><asp:Label Id="lblcharremain2" runat="server" Text="characters remaining
                                    out of 100"/><span id="CharactersCounter2">100</span></span>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <br />
                                    <span class="watermark"><asp:Label Id="lblcharremain3" runat="server" Text="characters remaining
                                    out of 100"/><span id="CharactersCounter3">100</span></span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:Label Id="lblpostal" runat="server" Text="Zip Code"/> :
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlCountry" ClientIDMode="Static" runat="server" onchange="print_state('ddlState',this.selectedIndex);" Width="211px">
                                    </asp:DropDownList>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlState" ClientIDMode="Static" runat="server" Width="211px">     <%--onchange="CheckDuplicateAddress();printZone(); printSubZone();"--%>
                                    </asp:DropDownList>
                                ...
                                <td>
                                    <asp:TextBox ID="txtcity" MaxLength="50" Width="210px" runat="server" ClientIDMode="Static"></asp:TextBox> <%--onchange="CheckDuplicateAddress()"--%>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddldepartment" DataTextField="ContactType" DataValueField="ID"
                                        Width="211px" runat="server" >    <%--onchange="Getcontact()"--%>    <%--onchange="Getcontact2()"--%>
                                    </asp:DropDownList>
                                </td>
                                <td style="display:none;">
                                    <asp:Label runat="server" ID="lblZone" Text="Contact 1" ClientIDMode="Static"></asp:Label>
                                    :
                                </td>
                                <td style="display:none;">
                                    <asp:DropDownList ID="ddlZone" ClientIDMode="Static" runat="server" Width="211px">
                                    </asp:DropDownList>
                                </td>
                                <td style="display:none;">
                                    <asp:Label runat="server" ID="lblSubZone" Text="Contact 2" ClientIDMode="Static"></asp:Label>
                                    :
                                </td>
                                <td style="display:none;">
                            ...
                            <tr>
                                ...
                                <td style="display:none;">
                                     <asp:Label runat="server" ID="lblphone1" Text="Phone No. 1" ClientIDMode="Static"></asp:Label>
                                    :
                                </td>
                                <td style="display:none;">
                                ...
                                <td style="display:none;">
                                   <asp:Label runat="server" ID="lblphone2" Text="Phone No. 2" ClientIDMode="Static"></asp:Label>
                                    : 
                                </td>
                                <td style="display:none;">
                ...
                <tr>
                    ...
                    <td style="width: 20%">
                        <table style="float: right;">
                            <tr>
                                <td>
                                    <input type="button" id="Button1" value="Submit" runat="server" onclick="SubmitAddress();" style="width: 70px;" />
                                </td>
                                <td>
                                    <input type="button" id="Button2" value="Clear" runat="server" onclick="ClearAddress()" style="width: 70px;" />
                                </td>
                            </tr>
                        </table>
                    </td>
    ...
    <script type="text/javascript">
        ...
        function Getcontact() {
            ...
            obj1.ddldeptid = ddldeptid.value.toString();
            PageMethods.GetLocation(obj1, getLoc_onSuccessed);
        }
        ...
        function AddOption(text, value) {
            ...
            ddlcontact1.options.add(option);
        ...
        function Getcontact2() {
            var obj1 = new Object();
            obj1.ddldeptid = ddldeptid.value.toString();
            PageMethods.GetLocation(obj1, getLoc2_onSuccessed);
        }

        function getLoc2_onSuccessed(result) {
        ...
        function AddOption2(text, value) {
            ...
            option.value = value;
            option.innerHTML = text;
            ddlcontact2.options.add(option);
    ...
    <script type="text/javascript">
        ...
        function SubmitAddress() {
            ...
            if (Page_IsValid) {
                ...
                AddressInfo.RouteID = document.getElementById("ddldepartment").value;
...
//                AddressInfo.contact1 = ddlZone.options[ddlZone.selectedIndex].text;
//                AddressInfo.contact2 = ddlSubZone.options[ddlSubZone.selectedIndex].text;
