    ...
    public partial class AddressInfo : System.Web.UI.Page
    {
        ...
        public static void PMSaveAddress(object AddressInfo)
        {
            ...
            try
            {
                ...
                HttpContext.Current.Session["DepartmentID"] = Convert.ToInt64(rec["RouteID"].ToString());
               ...
               // Address.RouteID = Convert.ToInt64(rec["RouteID"].ToString());
                Address.RouteID = long.Parse(HttpContext.Current.Session["CompanyID"].ToString());
                ...
                Address.CompanyID = long.Parse(HttpContext.Current.Session["CompanyID"].ToString());
            ...
            try
            {
                ...
                if (SequenceNo != "0")
                {
                   ...
                   // if (Address.RouteID != null) ddlRoute.SelectedIndex = ddlRoute.Items.IndexOf(ddlRoute.Items.FindByValue(Address.RouteID.ToString()));
                    ...
                    if (ddldepartment.Items.Count >= 1) ddldepartment.SelectedIndex = 0;
                    if (Address.RouteID != null) ddldepartment.SelectedIndex = ddldepartment.Items.IndexOf(ddldepartment.Items.FindByValue(Address.RouteID.ToString()));
                    hdndepartment.Value = Address.RouteID.ToString();
                    ddlZone.SelectedIndex = 0;
                    ddlZone.SelectedIndex = ddlZone.Items.IndexOf(ddlZone.Items.FindByValue(Address.Zone.ToString()));
                    //if (ddlZone.Items.Count >= 1) ddlZone.SelectedIndex = 0;
                    //if (Address.Zone != null) ddlZone.SelectedIndex = ddlZone.Items.IndexOf(ddlZone.Items.FindByValue(Address.Zone.ToString()));
                    ddlSubZone.SelectedIndex = 0;
                    ddlSubZone.SelectedIndex = ddlSubZone.Items.IndexOf(ddlSubZone.Items.FindByValue(Address.SubZone.ToString()));

                    //if (ddlSubZone.Items.Count >= 1) ddlSubZone.SelectedIndex = 0;
                    //if (Address.SubZone != null) ddlSubZone.SelectedIndex = ddlSubZone.Items.IndexOf(ddlSubZone.Items.FindByValue(Address.SubZone.ToString()));
        ...
        public static List<contact> GetLocation(object objReq)
        {
            ...
            try
            {
                ...
                long ddldeptid = long.Parse(dictionary["ddldeptid"].ToString());

                ds = ObjContactPerson.Getcontactbydeptid(ddldeptid, profile.DBConnection._constr);
