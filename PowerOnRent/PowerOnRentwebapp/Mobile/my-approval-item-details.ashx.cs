...
namespace PowerOnRentwebapp.Mobile
{
    ...
    public class my_approval_item_details : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            xmlString = xmlString + "<orderNumber>" + OrderNumber + "</orderNumber>";
            ...
            xmlString = xmlString + "<myRemark>" + appRemark + "</myRemark>";
            xmlString = xmlString + "<myStatus>" + appStatus + "</myStatus>";
