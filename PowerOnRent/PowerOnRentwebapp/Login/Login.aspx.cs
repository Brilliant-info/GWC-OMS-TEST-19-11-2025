        ...
        protected void loginuser_OnLoggedIn(object sender, EventArgs e)
        {
            ...
            if (profile1 != null)
            {
               ...
               // Session.Clear();
                ...
                //profile1.DBConnection._constr[0] = "QADO0TOMSDB01";
                //profile1.DBConnection._constr[1] = "GWCDEEcomm";
                //profile1.DBConnection._constr[2] = "Password123#";
                //profile1.DBConnection._constr[3] = "GWCTEST";

                profile1.DBConnection._constr[0] = "10.228.134.66";
                //profile1.DBConnection._constr[0] = "QADO0TOMSDB01";
                profile1.DBConnection._constr[1] = "GWCDEEcomm";
                profile1.DBConnection._constr[2] = "Password123#";
                profile1.DBConnection._constr[3] = "GWCTEST";

                //profile1.DBConnection._constr[0] = "SERVER\\SQLEXPRESS";
                //profile1.DBConnection._constr[1] = "GWCDETestNew";
                //profile1.DBConnection._constr[2] = "Password123#";
