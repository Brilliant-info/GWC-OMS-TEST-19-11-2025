...
<link rel="icon" type="image/x-icon" href="../MasterPage/Logo/GWCIcon.ico" />
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>GWC | Login</title>
    <style>
        body
        {
            margin: 0px;
                                            ...
                                            <tr>
                                                <td style="text-align: left;">
                                                    <asp:DropDownList ID="ddllanguage" runat="server" Width="205px">
                                                        ...
                                                        <asp:ListItem Value="en-US" Text="English" Selected="True" />
                                            ...
                                            <req>Password</req>
                                                        ...
                                                        <tr>
                                                            <td style="text-align: center;">
                                                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/login/SecirityQAForgotPassword.aspx">Forgot Password</asp:HyperLink>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
            ...
            <tr style="color: Gray; font-size: 14px;">
                <td colspan="2" style="text-align: left; vertical-align: top;">
                    ...
                    <a target="_blank" href="#">©2016 Gulf Warehousing </a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Release Version 2.0
                </td>
