...
namespace PowerOnRentwebapp.PowerOnRent
{
    public partial class DirectImportD : System.Web.UI.Page
    {
        ...
        protected void btnUploadPo_Click(object sender, EventArgs e)
        {
            ...
            iProductMasterClient productClient = new iProductMasterClient();
            CustomProfile profile = CustomProfile.GetProfile();
            string ObjectName = "DirectImport";
            ...
            //{
                ...
                if (validation == "true")
                {
                    WebMsgBox.MsgBox.Show("Another user is importing direct order. Please wait..");
                }
                else
                {
                   ...
                   //     sitecode = dt.Rows[0]["SiteCode"].ToString();
                    ...
                    //else
                    //{
                    //    dt.Columns.Add("ProjectType", typeof(System.String));
                    //    dt.Columns.Add("SiteCode", typeof(System.String));
                    //    dt.Columns.Add("CreatedBy", typeof(System.Int64));
                    //    foreach (DataRow dr in dt.Rows)
                    //    {
                    //        dr["ProjectType"] = null;
                    ...
                    string StoreProcedure = "Import_Insert_DirectImport";
                    using (SqlCommand sqlCommand = new SqlCommand(StoreProcedure, con1))
                    {
                        ...
                        SqlParameter tvpParam = sqlCommand.Parameters.AddWithValue("@VirtualData", dt);
            ...
            //catch (Exception ex)
            //{
            //    Login.Profile.ErrorHandling(ex, "DirectImportD.aspx", "btnUploadPo_Click");
