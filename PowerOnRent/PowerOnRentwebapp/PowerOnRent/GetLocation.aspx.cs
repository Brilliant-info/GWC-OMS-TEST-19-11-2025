    ...
    public partial class GetLocation : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Session["RequestorID"].ToString() != "")
                {
                    RequestorID = long.Parse(Session["RequestorID"].ToString());
                }
                if (RequestorID == 0)
                {
                    RequestorID=Convert.ToInt64(Request.QueryString["RequestorID"].ToString());
                }
                //if (Request.QueryString["RequestorID"] != null)
        ...
        protected void BindAddressList(long DeptID)
        {
            ...
            {
                LocLst = UCCommonFilter.GetLocationOfUser(RequestorID, profile.DBConnection._constr).ToList();
            }
        ...
        private void loadstring()
        {
           ...
           // btnSave.Value = rm.GetString("Save", ci);
            ...
            lblLocationList.Text= rm.GetString("LocationList", ci);
        }
    }
}