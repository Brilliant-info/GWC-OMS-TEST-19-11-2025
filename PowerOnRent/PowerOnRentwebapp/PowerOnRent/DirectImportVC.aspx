<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/CRM.Master" Theme="Blue"  EnableEventValidation="false" CodeBehind="DirectImportVC.aspx.cs" Inherits="PowerOnRentwebapp.PowerOnRent.DirectImportVC" %>
                    ...
                    <table cellpadding="0" width="100%" cellspacing="5px" border="0" class="tableForm">
                        <tr>
                            <td align="left" colspan="4">
                                ...
                                <a href="DirectBulkOrderImport.xlsx" target="_blank"><font color="blue"><u>Click Here.
                                </u></font></a>
                    ...
                    <table align="right">
                        <tr>
                            <td>
                                ...
                                <asp:Button ID="Button12" runat="server" Text="  Next  " OnClick="Button12_Click" CausesValidation="false" />
                                <%-- OnClientClick="return CheckDeptvalidations();"--%>
                            </td>
                            <td>
