<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM2.Master" AutoEventWireup="true" CodeBehind="AllocateDriver.aspx.cs" Theme="Blue"
    Inherits="PowerOnRentwebapp.PowerOnRent.AllocateDriver" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
    <table class="gridFrame" width="100%" style="margin: 3px 3px 3px 3px;">
        ...
        <tr>
            <td>
                    ...
                    PageSize="10" AllowPageSizeSelection="true"  ShowTotalNumberOfPages="true" AllowPaging="true"
   ...
   <asp:HiddenField ID="Hndisecom" runat="server" ClientIDMode="Static" />
    <script type="text/javascript">
        ...
        function selectedRec() {
            ...
            //document.getElementById("btnAllocateDriver").style.visibility = "hidden";
            ...
            {
                document.getElementById("<%= btnAllocateDriver.ClientID %>").style.visibility = "hidden";
        ...
        function OnSuccessAssignDriver(result) {
            ...
            if (result == "5") {
                showAlert("You assign maximum 25 order per driver. not more than 25! ", 'Error', '#');
            }
            else if (result == "2")
            {
                window.opener.AfterAssignDriver(); self.close();
            }
            else if (result == "1")
            {               
            ...
            //    { window.opener.AfterAssignDriver(); self.close(); }
            //    else if (result == "1")
            //    { window.opener.GridDispatchstatus.refresh(); self.close(); }
            //    //               
