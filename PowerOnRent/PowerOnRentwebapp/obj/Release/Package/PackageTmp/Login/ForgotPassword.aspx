...
<body>
    ...
    <div class="pnlLoginContent">
        <div class="pnlLoginContentSub">
            <form runat="server" id="frmForgotPassword" clientidmode="Static">
                                            ...
                                            <asp:PasswordRecovery ID="PasswordRecovery1" runat="server">
                                                <UserNameTemplate>
                                                    ...
                                                    <table class="tableForm" cellspacing="5" border="0">
                                                        ...
                                                        <tr id="trWaitProcessing" style="display:none;">
                                                            <td style="text-align: center; font-size: 25px; padding: 0 0 0 15px;">Wait Processing... 
                                                            </td>
                                                        </tr>
                                                        <tr id="trForgotPassword" style="display:;">
                                                            <td style="text-align: center; font-size: 25px; padding: 0 0 0 15px;">Forgot Password
                                                            </td>
                                                        </tr>
                                                        <tr id="trUserNameHolder" style="display:;">
                                                        ...
                                                        <tr id="trBtnSubmit" style="display:;">
                                                            <td style="text-align: left;">
                                                                <asp:Button ID="SubmitButton" runat="server" CommandName="Submit" Text="Submit" ValidationGroup="PasswordRecovery1" />
                                                            </td>
                                                        </tr>
                                                        <tr id="trFrmInfo" style="display:;">
                                                ...
                                                <SuccessTemplate>                                                   
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <asp:Image ID="ElegantLogoSuccess" runat="server" ImageUrl="~/MasterPage/Logo/GWCBrandNewLogo.png"
                                                                    Style="position: relative; left: 5px; width: 150px; margin-bottom: 10px;" />
                                                            </td>
                                                        </tr>                                                     
                                                        <tr>
                                                            <td style="text-align: center; font-size: 20px; padding: 0 0 0 15px;">Your password has been sent to your email address
                                                            </td>
                                                        </tr>                                                        
                                                        <tr>
                                                            <td>
                                                               
                                                                <div class="lnkLoginHolder">
                ...
                <asp:HiddenField ID="hdnUserNameVal" runat="server" ClientIDMode="Static" Value="" />
            </form>
        </div>
    </div>
    <script>
        var getUserNameCtrl = document.getElementById('PasswordRecovery1_UserNameContainerID_UserName');
        if (getUserNameCtrl != null) {
           
            var getHdnUserName = document.getElementById('hdnUserNameVal');
            getUserNameCtrl.value = getHdnUserName.value;
            // document.getElementById("PasswordRecovery1_UserNameContainerID_UserName").disabled = true;
            //document.getElementById("PasswordRecovery1_UserNameContainerID_UserName").setAttribute('style', 'display:none;');

            document.getElementById("trWaitProcessing").setAttribute('style', 'display:;');
            document.getElementById("trForgotPassword").setAttribute('style', 'display:none;');
            document.getElementById("trUserNameHolder").setAttribute('style', 'display:none;');
            document.getElementById("trBtnSubmit").setAttribute('style', 'display:none;');
            document.getElementById("trFrmInfo").setAttribute('style', 'display:none;');
            trFrmInfo
           //  getFrm.submit();
             document.getElementById('PasswordRecovery1_UserNameContainerID_SubmitButton').click();
             var getFrm = document.getElementById('frmForgotPassword');
        }
