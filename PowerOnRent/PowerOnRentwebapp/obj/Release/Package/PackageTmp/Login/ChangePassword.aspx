...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div runat="server" id="dchangepassword" clientidmode="Static">
          <br />
        <center>
            ...
            <table class="gridFrame" style="margin: 3px; width: 390px;">
                <tr>
                    <td>
                        <span id="headerText">
                            <asp:Label ID="lblheader" CssClass="headerText" runat="server" Text="Change Password"></asp:Label></span>
                    </td>
                    ...
                    <td colspan="2">
                        <table class="tableForm" style="background-color: White; width: 100%">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtCurrentPassword" runat="server" Width="200px" ClientIDMode="Static"
                                        ValidationGroup="ChangePassword" TextMode="Password" MaxLength="20"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtNewPassword" runat="server" ClientIDMode="Static" ValidationGroup="ChangePassword" MaxLength="20"
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtConfirmNewPassword" runat="server" ClientIDMode="Static" ValidationGroup="ChangePassword" MaxLength="20"
                                        TextMode="Password" Width="200px" MaxLength="20"
    ...
    <div runat="server" clientidmode="Static" id="dsecurityquestion">
        <center>
            <asp:ValidationSummary ID="ValidationSummary2" runat="server" ValidationGroup="Securityquestion"
                DisplayMode="BulletList" ShowMessageBox="true" ShowSummary="false" />
            <div id="divLoading1" style="height: 350px; width: 465px; display: none" class="modal">
                <center>
                    <br />
                    <span id="spanLoading1" style="font-size: 17px; font-weight: bold; color: Yellow;">Processing
                        please wait...</span>
                </center>
            </div>
            <br/>
            ...
            <table class="gridFrame" style="margin: 3px; width: 390px;">
                <tr>
                    <td>
                        <span id="headerText1">
                            <asp:Label ID="lblheader1" CssClass="headerText" runat="server" Text="Security Questions"></asp:Label></span>
                    </td>
                    <td style="text-align: right; width: 20%">
                        <table>
                            <tr>
                                <td>
                                    <input type="button" value="Save" id="btnsavequeans" runat="server" onclick="SaveQuestionAnswer()" />
                                </td>
                                <td>
                                    <input type="button" value="Clear" id="btnclearqueans" runat="server" onclick="clearQuestionAnswer();" />
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td colspan="2">
                        <table class="tableForm" style="background-color: White; width: 100%">
                           <%-- <tr>
                            ...
                            <tr>
                                <td style="width: 100%; text-align: left">
                                    <asp:DropDownList ID="ddlquestion1" ValidationGroup="Securityquestion" Width="100%" runat="server"></asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" InitialValue="0" runat="server" ErrorMessage="Select Security Question1"
                                        ControlToValidate="ddlquestion1" ValidationGroup="Securityquestion" Display="None">
                                    </asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 100%; text-align: left">
                                    ...
                                    <asp:TextBox ID="txtanswer1" Width="100%" runat="server" ClientIDMode="Static"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter Question Answer"
                                        ControlToValidate="txtanswer1" ValidationGroup="Securityquestion" Display="None">
                                    </asp:RequiredFieldValidator>
                                </td>
                            </tr>
    ...
    <script type="text/javascript">
        ...
        function SaveQuestionAnswer() {
           ...
           // var q2 = question2.value;
            ...
            if (q1 == "0" || q1 == "") {
                alert('Select Security Question1');
            }
            //else if (q2 == "0" || q1 == "") {
            //    alert('Select Security Question2');
            //}
            else if (txtanswer1.value == "") {
                alert('Please Answer Question');
            }
            //else if (txtanswer2.value == "") {
            //    alert('Please Answer Question');
            //}
            else {
                var obj1 = new Object();
        ...
        function OnSuccessWMChkSecurityQuestion(result) {
            ...
            if (result == "match") {
                var dchangepassword = document.getElementById("<%= dchangepassword.ClientID%>");
                var dsecurityquestion = document.getElementById("<%= dsecurityquestion.ClientID%>");
                dchangepassword.style.display = "block"; // Visible
                dsecurityquestion.style.display = "none"; // Hidden
            }
            else if (result == "100") {
                // showAlert("Please select unique security question and fill the answer !!!", "Error", '#');
                ...
                //showAlert("Answer not match !!!", "Error", "#");
