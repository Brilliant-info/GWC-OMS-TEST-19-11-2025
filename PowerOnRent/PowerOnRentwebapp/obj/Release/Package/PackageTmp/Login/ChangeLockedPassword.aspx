<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM2.Master" AutoEventWireup="true"
    CodeBehind="ChangeLockedPassword.aspx.cs" Inherits="PowerOnRentwebapp.Login.ChangeLockedPassword" %>
                                                    ...
                                                    <td >
                                                        <table  style=" width: 104%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: left;">
                                                                    <asp:TextBox ID="txtCurrentPassword" runat="server" Width="200px" ClientIDMode="Static" CssClass="inputElement"
                                                                       Placeholder="Current Password"  ValidationGroup="ChangePassword" TextMode="Password" MaxLength="20"></asp:TextBox>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: left;">
                                                                    <asp:TextBox ID="txtNewPassword" runat="server" ClientIDMode="Static" ValidationGroup="ChangePassword" CssClass="inputElement" MaxLength="20"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: left;">
                                                                    <asp:TextBox ID="txtConfirmNewPassword" runat="server" ClientIDMode="Static" ValidationGroup="ChangePassword" CssClass="inputElement"
                                                                        TextMode="Password" Width="200px" Placeholder="Confirm Password" MaxLength="20"
