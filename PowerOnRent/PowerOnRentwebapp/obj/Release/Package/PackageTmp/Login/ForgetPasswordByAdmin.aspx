<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgetPasswordByAdmin.aspx.cs" Inherits="PowerOnRentwebapp.Login.ForgetPasswordByAdmin" %>
        ...
        <div class="pnlLoginContentSub">
            <form runat="server">
                ...
                <div>
                                            ...
                                            <asp:PasswordRecovery ID="PasswordRecovery1" runat="server">
                                                    ...
                                                    <table class="tableForm" cellspacing="5" border="0">
                                                        ...
                                                        <tr>
                                                            <td style="text-align: left;">
                                                                <span id="spnFailureMsg1" style="display: none;">
                                                                ...
                                                                <script>
                                                                    var getErrorHolder = document.getElementById('spnFailureMsg1');
                                                                    if (getErrorHolder != null) {
                                                                        var getErrHtml1 = (getErrorHolder.innerHTML).trim();
                                                                        if (getErrHtml1 != '') {
                                                ...
                                                <SuccessTemplate>
                                                    <table class="tableForm">
                                                        <tr>
                                                            <td>User password has been sent to user email address
                                                            <br />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:HyperLink ID="hyperlink1" runat="server" NavigateUrl="~/Inbox/InboxPOR.aspx">Back</asp:HyperLink>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </SuccessTemplate>
                    ...
                    <asp:HiddenField ID="hdnuname" runat="server" ClientIDMode="Static" />
                    <script>

                        //document.getElementById('PasswordRecovery1_UserNameContainerID_UserName');
                        var getUNameObj = document.getElementById('PasswordRecovery1_UserNameContainerID_UserName');
                        var hdnuname= document.getElementById("<%=hdnuname.ClientID %>")
                        getUNameObj.onblur = function () {
                            hdnuname.value = getUNameObj.value;                           
                        };
