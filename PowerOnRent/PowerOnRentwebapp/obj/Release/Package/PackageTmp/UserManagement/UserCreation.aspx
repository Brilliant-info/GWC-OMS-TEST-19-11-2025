...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHolder_Form" runat="server">
    ...
    <center>
        <asp:TabContainer ID="TabContainerUserCreation1" runat="server" ActiveTabIndex="2">
                        ...
                        <table class="gridFrame" style="width: 100%">
                                    ...
                                    <table style="width: 100%">
                                        <tr>
                                            ...
                                            <td align="right">
                                                ...
                                                <input type="button" id="btnclearquestion" runat="server" value="Clear Security Questions" style="cursor: pointer; padding: 4px 14px;"
                                                    onclick="ClearSecurityQuestions(); return false;" />
                                                <input type="button" id="btnAllocate" runat="server" value="Lock/Unlock" style="cursor: pointer; padding: 4px 14px;"
                                                    onclick="lockunlock(); return false;" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <obout:Grid ID="gvUserCreationM" runat="server" AllowAddingRecords="False" AutoGenerateColumns="False" AllowFiltering="True"
                                        Width="100%" AllowGrouping="True" AllowMultiRecordSelection="false" AllowRecordSelection="true" Serialize="true"
                                        CallbackMode="true"
                                        ...
                                        <Columns>
                                            ...
                                            <obout:Column DataField="DeptName" HeaderText="Department" Width="20%" Index="3" Visible="false">
                                            </obout:Column>
                    ...
                    <center>
                        <table class="tableForm" border="0">
                            ...
                            <tr>
                                <td>
                                    <%--<req>--%>
                                    <asp:Label ID="lblgender" runat="server" Text="Gender" /><%--</req>--%>
                                    :
                                </td>
                                <td style="text-align: left;">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:DropDownList ID="ddlDepartment" runat="server" ValidationGroup="Save" DataTextField="Territory" Visible="false"
                                        DataValueField="ID" Width="187px" onchange="GetDepartment(this);"
                                        ClientIDMode="Static">
                                    </asp:DropDownList>
                                    <a id="btnAssignDepartment" onclick="AssignLocation();" style="margin-top: -20px;">
                                        <asp:Label ID="lblassigndept" Visible="false" runat="server" Text="Assign Department" /></a>
                            ...
                            <tr>
                                <td colspan="3" style="text-align: left; border: 1px solid Silver; display: none">
                                    <div id="divSelectedLocation" runat="server" clientidmode="Static" style="width: 415px; float: right;">
                                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtPassword1" runat="server" Width="180px" ClientIDMode="Static" MaxLength="20"
                                ...
                                <td>
                                    <asp:TextBox ID="txtConfirmPassword" runat="server" onblur="Javascript:CheckPassword();" MaxLength="20"
            ...
            <asp:TabPanel ID="pnllocation" runat="server" HeaderText="Add Location">
                <ContentTemplate>
                    <center>
                        <%-- <table>
                            <tr>
                                <td>
                                    <asp:Label ID="lblddllocation" style="font-size:12px;font-family:Arial;color:black;" runat="server" Text="Select Location"></asp:Label> :
                                </td>
                                <td>
                                     <asp:DropDownList ID="ddllocation" runat="server" ValidationGroup="Save" Width="187px" onchange="AssignLocation()">
            ...
            <asp:TabPanel ID="pnldepartment" runat="server" HeaderText="Department">
                <ContentTemplate>
                    <center>
                        <table class="gridFrame" width="100%">
                            <tr>
                                <td>
                                    <table style="width: 100%">
                                        <tr>
                                            <td style="text-align: left;">
                                                <%-- <a style="color: white; font-size: 15px; font-weight: bold;">Additional Distribution</a>--%>
                                                <asp:Label ID="lbldeptlist" Style="color: white; font-size: 15px; font-weight: bold;" runat="server" Text="Department list"></asp:Label>
                                            </td>
                                            <td style="text-align: right;">
                                                <input type="button" id="Button1" runat="server" value="Add Department" onclick="opendepartmentSearch('0')" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <obout:Grid ID="Gvassigndept" runat="server" AllowAddingRecords="false" AllowRecordSelection="false" Width="100%"
                                        AutoGenerateColumns="false" AllowPaging="true" AllowFiltering="true" AllowGrouping="true"
                                        AllowSorting="true">
                                        <ScrollingSettings ScrollHeight="250" />
                                        <Columns>
                                            <obout:Column DataField="Sequence" HeaderText="Remove" Width="5%" AllowSorting="false"
                                                Align="Center" HeaderAlign="Center">
                                                <TemplateSettings TemplateId="GvRemoveDept" />
                                            </obout:Column>

                                            <obout:Column HeaderText="Department" DataField="Territory" Width="150px">
                                            </obout:Column>
                                            <obout:Column HeaderText="Department Code" DataField="StoreCode" Width="150px">
                                            </obout:Column>
                                            <obout:Column HeaderText="Auto Cancel" DataField="AutoCancel" Width="150px">
                                            </obout:Column>
                                            <obout:Column HeaderText="E-Commerce" DataField="ECommerce" Width="150px">
                                            </obout:Column>
                                            <obout:Column HeaderText="Price Change" DataField="PriceChange" Width="150px">
                                            </obout:Column>
                                        ...
                                        <Templates>
                                            <obout:GridTemplate ID="GvRemoveDept" runat="server">
                                                <Template>
                                                    <img id="imgbuttonremove" src="../App_Themes/Grid/img/Remove16x16.png" alt="Remove" title="Remove" onclick="RemoveDepartment('<%# (Container.DataItem["ID"].ToString()) %>');"
                                                        style="cursor: pointer;" />
                                                </Template>
                                            </obout:GridTemplate>
                                        </Templates>
    ...
    <asp:HiddenField ID="hdnDepatmentName" runat="server" ClientIDMode="Static" />
    <asp:HiddenField ID="hdnDepatmentId" runat="server" ClientIDMode="Static" />
    <style type="text/css">
        .newlocationdiv {
            top: 0;
            left: 0;
    ...
    <asp:HiddenField ID="hdnSelectedRecUserIDnew" runat="server" ClientIDMode="Static" />
    ...
    <script type="text/javascript">
        ...
        function GetRoll() {
            ...
            var hnduserID = document.getElementById("<%=hnduserID.ClientID %>");
            if (hnduserID.value != "") {
                PageMethods.CheckRole(hnduserID.value, hdnrollid.value, hndstate.value, RoleChkSucess, null)
            }
            // alert(hdnSelectedCompany.value);
        }

        function RoleChkSucess(result) {
            if (result == 1) {
                showAlert("Please Remove User From Approvel Level", "Error", "#");
            }
    ...
    <%--<script type="text/javascript">
      function BindDepartmentchecklist() {

          PageMethods.PMGetDepartmentList(hdnSelectedCompany.value, onSuccessGetDepartmentList, null)
      }
      function onSuccessGetDepartmentList(result) {
          var ddlchk = document.getElementById('<%=yearsDropDownCheckBoxes.ClientID%>');
          ddlchk.options.length = 0;
          var option2 = document.createElement("option");
          ...
          for (var i = 0; i < result.length; i++) {
              var option3 = document.createElement("option");
              option3.text = result[i].Territory;
              option3.value = result[i].ID;
              try {
                  ddlDepartment.add(option3, null);
              }
              catch (Error) {
                  ddlDepartment.add(option3);
              }
          }
    ...
    <script type="text/javascript">
        ...
        function RemoveDepartment(ID) {
            var obj1 = new Object();
            var UserDeptID = ID;
            obj1.UserDeptID = UserDeptID;
            PageMethods.RemoveDepartment(obj1, RemoveDept_onSuccess);
        }

        function RemoveDept_onSuccess(result) {
            Gvassigndept.refresh();
        }

    </script>

    <script type="text/javascript">
        function opendepartmentSearch(sequence) {
            var ddlcompany = document.getElementById("<%=ddlcompany.ClientID %>");
            ...
            var UserId = document.getElementById("<%=hnduserID.ClientID %>").value;
            window.open('../UserManagement/DepartmentList.aspx?CompanyId=' + CompanyId + "&userid=" + UserId + "", null, 'height=700px, width=825px,status= 0, resizable= 1, scrollbars=1, toolbar=0,location=center,menubar=0, screenX=300; screenY=50');
        }
    ...
    <script type="text/javascript">
        ...
        function selectRec() {
            //var hdnSelectedRecUserIDnew = document.getElementById("hdnSelectedRecUserIDnew");
            ...
            for (i = 0; i < gvUserCreationM.PageSelectedRecords.length; i++) {
                ...
                if (hdnSelectedRecUserID.value == "") hdnSelectedRecUserID.value = record.userIDPass;
                //if (hdnSelectedRecUserIDnew.value != "") hdnSelectedRecUserIDnew.value += ',' + record.userID;
                //if (hdnSelectedRecUserIDnew.value == "") hdnSelectedRecUserIDnew.value = record.userID;
                if (hdnuserlock.value != "") hdnuserlock.value += ',' + record.locked;
                if (hdnuserlock.value == "") hdnuserlock.value = record.locked;
            }
        }
        function gvUserCreationM_Deselect(index) {
            selectRec();
        }
        ...
        function selectedRec() {
            var hdnSelectedRecUserIDnew = document.getElementById("hdnSelectedRecUserIDnew");
            hdnSelectedRecUserIDnew.value = "";
            if (gvUserCreationM.SelectedRecords.length > 0)
            {
                for (var i = 0; i < gvUserCreationM.SelectedRecords.length; i++) 
                {
                    var record = gvUserCreationM.SelectedRecords[i];
                    if (hdnSelectedRecUserIDnew.value != "") hdnSelectedRecUserIDnew.value += ',' + record.userID;
                    if (hdnSelectedRecUserIDnew.value == "") hdnSelectedRecUserIDnew.value = record.userID;
                }              
        ...
        function ClearSecurityQuestions() {
           var hdnSelectedRecUserIDnew = document.getElementById("hdnSelectedRecUserIDnew");
            hdnSelectedRecUserIDnew.value = "";
            if (gvUserCreationM.SelectedRecords.length > 0)
            {
             ...
             if (gvUserCreationM.SelectedRecords.length == 0) {
                ...
                var r = confirm("Are You Sure to Clear Security Question and Ansrer?")
                 if (r == true) {
                     PageMethods.WMClearSecurityQuestions(hdnSelectedRecUserIDnew.value, OnSuccessSecurityQuestions, null);
                }
            }
        }

        function OnSuccessSecurityQuestions(result) {
            if (result == "failed") {
