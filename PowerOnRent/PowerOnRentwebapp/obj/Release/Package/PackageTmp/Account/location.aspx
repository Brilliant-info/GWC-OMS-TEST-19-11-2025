<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM.Master" AutoEventWireup="true" CodeBehind="location.aspx.cs" EnableEventValidation="false"
    Inherits="PowerOnRentwebapp.Account.location" Theme="Blue" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHolder_Form" runat="server">
                    ...
                    <center>
                        <table class="tableForm">
                            ...
                            <td style="text-align: left">
                                ...
                                <td>
                                   <asp:TextBox ID="txtlocation" runat="server" MaxLength="100" Width="200px" onchange="CheckLoCationCode()"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RFValddlCountry" runat="server" ForeColor="Maroon"
                                       ValidationGroup="Save" InitialValue="0" ControlToValidate="ddlCountry"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RFValstate" ForeColor="Maroon" ControlToValidate="ddlState"
                                     ValidationGroup="Save"   InitialValue="0" runat="server" ErrorMessage="Select State" Display="None"></asp:RequiredFieldValidator>
                                </td>
                                <td>
    ...
    <script type="text/javascript">
        function CheckLoCationCode() {
            var locationcode = document.getElementById("<%= txtlocation.ClientID %>").value;
            PageMethods.WMCheckLocationCode(locationcode, onsuccess, null)
        }
        ...
        function onsuccess(value)
        {
            if (value == 1)
            {
                showAlert("Location Code Already Exist!", "error", "#");
