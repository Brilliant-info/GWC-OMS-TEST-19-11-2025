<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM2.Master" AutoEventWireup="true" CodeBehind="PMethodList.aspx.cs"
    Inherits="PowerOnRentwebapp.Account.PMethodList" Theme="Blue" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OpenPMethod() {          
         //   window.open('../Account/PaymentMethod.aspx?deptid=' + deptid , null,'_blank','height=400px, width=505px,status= 0, resizable= 1, scrollbars=1, toolbar=0,location=center,menubar=0, screenX=300; screenY=50');
