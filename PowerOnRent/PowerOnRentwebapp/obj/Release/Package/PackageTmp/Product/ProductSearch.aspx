<%@ Page Title="Product Search" Language="C#" MasterPageFile="~/MasterPage/CRM2.Master"
    AutoEventWireup="true" Theme="Blue" CodeBehind="ProductSearch.aspx.cs" Inherits="PowerOnRentwebapp.Product.ProductSearch" EnableEventValidation="false" %>
            ...
            <td>
                <obout:Grid ID="GridProductSearch" runat="server" AutoGenerateColumns="false" AllowFiltering="false"
                    ...
                    <Columns>
                        ...
                        <obout:Column DataField="GroupSet" Visible="true" HeaderText="GroupSet" Width="10%"
    ...
    <script type="text/javascript">
        ...
        function selectedRec() {
            ...
            if (GridProductSearch.SelectedRecords.length > 0)
            {
               ...
               PageMethods.PrductStockCount(hdnProductSearchSelectedRec.value, OnSuccessPrductStockCount);
        ...
        function OnSuccessPrductStockCount(result) { 
            if(result!=0)
            {            
              //  alert(result);
            }
       ...
       /* function OnfailedPrductStockCount() {                       
