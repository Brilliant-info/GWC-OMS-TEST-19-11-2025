<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM.Master" AutoEventWireup="true" CodeBehind="VSkuImport.aspx.cs"
     Inherits="PowerOnRentwebapp.Product.VSkuImportD" Theme="Blue" %>
                    ...
                    <table cellpadding="0" width="100%" cellspacing="5px" border="0" class="tableForm">
                        <tr>
                            <td style="text-align :left" colspan="4">
                                     ...
                                     <asp:Label ID="lbltext1" runat="server" Font-Size="14px" Text="Import will faciliated Virtual SKU to be directly imported into OMS."></asp:Label>
                                   <%-- <span style="font-size:14px;"> Import will faciliated Order Data to be directly imported into OMS.</span><br />--%>
                                    ...
                                    <a href="VurtualSKUImport Template.xlsx" id="downloadlink" runat="server" target="_blank"><font color="blue"><u>Click Here.
                              ...
                              <table>
                                 <tr>
                                     ...
                                     <td style="text-align: right;" >
                                          <asp:Button ID="btnupload" runat="server" Text="  Upload  " OnClientClick="return ProgressBar()" OnClick="btnUploadPo_Click" /> 
        ...
        <table>
            ...
            <tr>
                <td colspan="3">                                                                                        <%-- OnRowDataBound="GVImportView_OnRowDataBound"--%>
                        <obout:Grid ID="Grid1" runat="server" AllowGrouping="true" Serialize="false"
                        CallbackMode="true" AllowRecordSelection="true" AllowColumnReordering="true"
                        AllowMultiRecordSelection="false" AllowFiltering="false" Width="100%" PageSize="100"
                        ...
                        <Columns>
                            ...
                            <obout:Column DataField="Name" HeaderText="SKU Name" HeaderAlign="left" Align="left" Width="6%"> </obout:Column>
                            <obout:Column DataField="Description" HeaderText="SKU Description" HeaderAlign="left" Align="left" Width="8%"></obout:Column>
                            <obout:Column DataField="PrinciplePrice" HeaderText="Principle Price" HeaderAlign="center" Align="right" Width="4%"> </obout:Column>
                             <obout:Column DataField="DepartmentCode" HeaderText="Department Code" HeaderAlign="left" Align="left" Width="5%"> </obout:Column>
                            <obout:Column DataField="Packkey" HeaderText="Pack Key" HeaderAlign="left" Align="left" Width="4%"> </obout:Column>
                             <obout:Column DataField="VirtualSkuQty" HeaderText="Virtual Sku Qty" HeaderAlign="Center" Align="right" Width="4%"> </obout:Column>
                             <obout:Column DataField="VirtualReOrderQty" HeaderText="Virtual ReOrder Qty" HeaderAlign="left" Align="right" Width="5%"> </obout:Column>
                             <obout:Column DataField="skuchk" HeaderText="skuchk" HeaderAlign="center" Align="left" Width="1%" Visible="false"> </obout:Column>
                             <obout:Column DataField="SKUPresent" HeaderText="SKUPresent" HeaderAlign="center" Align="left" Width="1%" Visible="false"> </obout:Column>
                             <obout:Column DataField="Deptchk" HeaderText="Deptchk" HeaderAlign="center" Align="left" Width="1%" Visible="false"> </obout:Column>
                             <obout:Column DataField="Qtychk" HeaderText="Qtychk" HeaderAlign="left" Align="left" Width="1%" Visible="false"></obout:Column>
                             <obout:Column DataField="chkduplicate" HeaderText="chkduplicate" HeaderAlign="left" Align="left" Width="1%" Visible="false"></obout:Column>
                             <obout:Column DataField="ReQtychk" HeaderText="ReQtychk" HeaderAlign="left" Align="left" Width="1%" Visible="false"></obout:Column>
            ...
            <table class="tblcls" cellpadding="0" cellspacing="20px" border="0" width="95%">
                ...
                <tr>
                    <td style="text-align:center">
                        <span>
                            <h1>
                                 <asp:Label ID="Label8" runat="server" Text="Data Importing Successfully Finished!"></asp:Label>
