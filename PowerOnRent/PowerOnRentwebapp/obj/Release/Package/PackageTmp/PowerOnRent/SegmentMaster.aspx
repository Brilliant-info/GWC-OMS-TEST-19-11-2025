<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM.Master" AutoEventWireup="true" CodeBehind="SegmentMaster.aspx.cs" Inherits="PowerOnRentwebapp.PowerOnRent.SegmentMaster" Theme="Blue" EnableEventValidation="false" %>
                ...
                <ContentTemplate>
                    <center>
                        ...
                        <table class="tableForm" style="width: 50%" id="tblAddAdrs" runat="server">
                            <tr runat="server">
                                <td runat="server">
                                    <req><asp:Label Id="lblprojecttype" runat="server" Text="Segment Master"/>

</req>
                                    :
                                </td>
                                <td style="text-align: left" runat="server">
                                    <asp:TextBox ID="txtSegmenttype" Width="200px" runat="server" 
                                    ...
                                    <table style="width: 100%">
                                        <tr>
                                            <td style="text-align: left;">
                                                <a id="headerText">
                                                    <asp:Label ID="lblAddressList" runat="server" Text="Segment Type List" /></a>
                                            </td>
                                ...
                                <td colspan="2">
                                    <obout:Grid ID="gvContactPerson" runat="server" AutoGenerateColumns="False" AllowAddingRecords="False"
                                        ...
                                        <Columns>
                                            ...
                                            <obout:Column DataField="SegmentType" HeaderText="Segment Type" Width="15%" Index="1">
                                            </obout:Column>
