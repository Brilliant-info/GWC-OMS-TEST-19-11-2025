<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM2.Master" AutoEventWireup="true" CodeBehind="GetLocation.aspx.cs" Inherits="PowerOnRentwebapp.PowerOnRent.GetLocation" 
                    ...
                    <tr>
                        <td colspan="2">
                            <obout:Grid ID="gvContactPerson" runat="server" AutoGenerateColumns="False" AllowAddingRecords="False"
                                ...
                                <Columns>
                                    <obout:Column HeaderText="" DataField="ID" Width="5%" Align="center" HeaderAlign="center" Visible="false">
    ...
    <asp:HiddenField ID="hdnSelectedRec" runat="server" ClientIDMode="Static" />
     <script type="text/javascript">
         ...
         //function SaveContactDetail() {
           ...
           //  var txtContactName = document.getElementById("");
           //  var txtEmailID = document.getElementById("");
           //  var txtContactNo = document.getElementById("");
        ...
        function GetContactPerson() {
            ...
            if (hdnSelectedRec.value == "") {
                ...
                if (count >= 1) {
                    ...
                    var hdnlocationname = window.opener.document.getElementById("hdnlocationname");
                    var hdnlocationcode = window.opener.document.getElementById("hdnlocationcode");
                    ...
                    if (gvContactPerson.SelectedRecords.length > 0) {
                        for (var i = 0; i < gvContactPerson.SelectedRecords.length; i++) {
                            ...
                            if (hdnSearchAddressID.value == "") {
                                ...
                                hdnlocationname.value = record.LocationName;
                                hdnlocationcode.value = record.LocationCode;
                        ...
                        window.opener.AfterLocationSelected(hdnSearchAddressID.value, hdnSearchAddress.value, hdnLocConID.value, hdnLocConName.value, hdnlocationname.value, hdnlocationcode.value);
                        self.close();
                    }
                }
            }
