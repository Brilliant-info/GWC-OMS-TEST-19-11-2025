<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM2.Master" AutoEventWireup="true" CodeBehind="AddEditSearchAddress.aspx.cs" Inherits="PowerOnRentwebapp.PowerOnRent.AddEditSearchAddress"
                ...
                <table class="tableForm" id="tblAddAdrs" runat="server">
                    <tr>
                        ...
                        <td style="text-align: left" colspan="4">
                            <asp:TextBox ID="txtAddress" TextMode="MultiLine" runat="server" Width="435px" MaxLength="200"
                                onkeyup="TextBox_KeyUp(this,'CharactersCounter1','200');" ClientIDMode="Static"
