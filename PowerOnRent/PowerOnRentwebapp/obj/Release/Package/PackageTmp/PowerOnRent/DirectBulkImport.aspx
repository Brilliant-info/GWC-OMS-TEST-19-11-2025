<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/CRM.Master" Theme="Blue" CodeBehind="DirectBulkImport.aspx.cs" Inherits="PowerOnRentwebapp.PowerOnRent.DirectBulkImport" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHolder_Form" runat="server">
    ...
    <div id="divRequestHead">
        <h4>
            <asp:Label ID="lblHeading" runat="server" Text="Import Direct Order"></asp:Label>
        </h4>
    </div>
                        ...
                        <table align="center">
                            <tr>
                                <td class="tdCartStepHolder">
                                    <span class="cartStepHolder"><span class="cartStepTitle"><span class="divCartSymbol">1</span><asp:Label ID="lblstep1" runat="server" Text="Upload File"></asp:Label></span><span class="cartStepTitle cartStepCurrentTitle"><span
            ...
            <tr>
                <td align="center">
                    <div id="divUpload" style="display: none">
                        <asp:Image ID="uploadimg" runat="server" ImageUrl="~/images/Please Wait.gif" Width="300" Height="80" />
                    </div>
                </td>
            </tr>
            <tr>
                    ...
                    <table class="gridFrame" style="width: 100%">
                        <tr>
                            ...
                            <td style="text-align: right;">
                                <asp:Button ID="btnnext" runat="server" Text="   Next   " Style="width: 90px;" Font-Size="18px" OnClientClick="return ProgressBar()" OnClick="btnnext_Click" />
                            </td>
                            <td style="text-align: right;">
                        ...
                        <tr>
                            <td>
                                <obout:Grid ID="GVImportView" runat="server" AllowGrouping="true" Serialize="false"
                                    ...
                                    AllowMultiRecordSelection="false" AllowFiltering="false" Width="116%" PageSize="100"
                                    ...
                                    <Columns>
                                        ...
                                        <obout:Column DataField="RequestQty" HeaderText="Request Qty" HeaderAlign="Center" Align="right" Width="5%"></obout:Column>
                                        ...
                                        <obout:Column DataField="AbailBalQtyChk" HeaderText="AbailBalQtyChk" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>
                                        <obout:Column DataField="chkduplicate" HeaderText="chkduplicate" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>
                                        <obout:Column DataField="ChkActive" HeaderText="ChkActive" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>
                                      
                                        <obout:Column DataField="Title" HeaderText="Title" HeaderAlign="left" Align="left" Width="8%"></obout:Column>
                                         <obout:Column DataField="Titlechk" HeaderText="Titlechk" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>
                                        <obout:Column DataField="PaymentType" HeaderText="PaymentType" HeaderAlign="left" Align="left" Width="8%"></obout:Column>
                                         <obout:Column DataField="PaymentavltodeptTypechk" HeaderText="PaymentavltodeptTypechk" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>
                                        <obout:Column DataField="PayMethodValue" HeaderText="PayMethodValue" HeaderAlign="left" Align="left" Width="8%"></obout:Column>
                                         <obout:Column DataField="BTAInstallmentValue" HeaderText="InstallmentValue" HeaderAlign="left" Align="left" Width="8%"></obout:Column>
                                        
                                         <%--28--%>
                                        <obout:Column DataField="PayMethodValuechk" HeaderText="PayMethodValuechkchk" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>
                                         <%--30--%>
                                         <obout:Column DataField="CostCenteruChk" HeaderText="CostCenteruChk" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>
                                       
                                        <obout:Column DataField="chklpopayment" HeaderText="CostCenteruChk" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>
                                        <obout:Column DataField="chklbtapayment" HeaderText="CostCenteruChk" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>
                                        <obout:Column DataField="chkcodpayment" HeaderText="CostCenteruChk" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>
                                        <obout:Column DataField="chksippayment" HeaderText="CostCenteruChk" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>
                                        <obout:Column DataField="chkccpayment" HeaderText="CostCenteruChk" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>                                        
                                        <obout:Column DataField="Ecommercedept" HeaderText="CostCenteruChk" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>
                                         <obout:Column DataField="ChkApprovalDept" HeaderText="CostCenteruChk" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>
                                         <obout:Column DataField="finapproverckh" HeaderText="CostCenteruChk" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>
                                        <obout:Column DataField="chkinstpayment" HeaderText="chkinstpayment" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>
                                        <obout:Column DataField="EnterpriseSegment" HeaderText="Enterprise Segment" HeaderAlign="left" Align="left" Width="8%"></obout:Column>
                                        <obout:Column DataField="Segmentchk" HeaderText="Segmentchk" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column><%--41--%>
                                    </Columns>
                                    <Templates>
    ...
    <script type="text/javascript">
        function ProgressBar() {
            ...
            document.getElementById('lblOkMessage').style.display = 'none';
            document.getElementById('lblOkMessage').style.visibility = "hidden";
            document.getElementById('lblOkMessage').innerHTML = "Please Wait";
