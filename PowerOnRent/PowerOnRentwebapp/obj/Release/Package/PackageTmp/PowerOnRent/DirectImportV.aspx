<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM.Master" AutoEventWireup="true" CodeBehind="DirectImportV.aspx.cs"
    Inherits="PowerOnRentwebapp.PowerOnRent.DirectImportV" Theme="Blue" %>
                            ...
                            <td>
                                <obout:Grid ID="GVImportView" runat="server" AllowGrouping="true" Serialize="false"
                                    ...
                                    <Columns>
                                        ...
                                        <obout:Column DataField="ProjectType" HeaderText="Project Type" HeaderAlign="left" Align="left" Width="8%"></obout:Column>
                                        <obout:Column DataField="SiteCode" HeaderText="Site Code" HeaderAlign="left" Align="left" Width="8%"></obout:Column>
                                        <obout:Column DataField="EnterpriseSegment" HeaderText="Enterprise Segment" HeaderAlign="left" Align="left" Width="8%"></obout:Column>
                                        <obout:Column DataField="PrjTypechk" HeaderText="PrjTypechk" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>
                                        <obout:Column DataField="Sitecodechk" HeaderText="Sitecodechk" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>
                                        <obout:Column DataField="Deptmoneychk" HeaderText="Deptmoneychk" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>
                                          <obout:Column DataField="simprdcheck" HeaderText="Sim Product" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>
                                        <obout:Column DataField="Segmentchk" HeaderText="chksegment" HeaderAlign="left" Align="left" Width="1%" Visible="false">
                                        </obout:Column>
                                    </Columns>
                                    <Templates>
