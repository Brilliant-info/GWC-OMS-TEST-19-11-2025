<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AccountMaster.aspx.cs" Inherits="PowerOnRentwebapp.Account.AccountMaster" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHolder_Form" runat="server">
    ...
    <%-- <ContentTemplate>--%>
    <center>
        <asp:TabContainer runat="server" ID="tabAccountMaster" ActiveTabIndex="0" Width="100%">
            <asp:TabPanel ID="TabCustomerList" runat="server" HeaderText="Customer List">
                <ContentTemplate>
                    ...
                    <asp:HiddenField ID="hdnRequestorName" runat="server" ClientIDMode="Static" />
                    <asp:HiddenField ID="hdnRequestorID" runat="server" ClientIDMode="Static" />
                     <asp:HiddenField ID="hdnmerchantCode" runat="server" ClientIDMode="Static" />
                                ...
                                <td>
                                    <obout:Grid ID="GvCustomer" runat="server" AutoGenerateColumns="False" AllowAddingRecords="False"
                                        ...
                                        <Columns>
                                            ...
                                            <obout:Column DataField="Name" HeaderText="Customer Name" Width="20%" Index="2">
                                            </obout:Column>
                    ...
                    <center>
                        <table class="tableForm">
                            ...
                            <tr>
                                ...
                                <td>
                                   <req>   <asp:Label ID="lblsourceEmail" runat="server" Text="Source Email"></asp:Label>  </req> :
                                </td>
                                <td>
                                    <asp:TextBox ID="txtsourceEmail" runat="server" Width="200px"></asp:TextBox>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtsourceEmail"
                                        Display="None" ErrorMessage="Please enter valid source Email ID" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
                                        ValidationGroup="Save"></asp:RegularExpressionValidator>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="auto-style1">
                                    <asp:Button ID="btncustomernext" runat="server" Text="  Next  " OnClick="btncustomernext_Click"
                    ...
                    <center>
                        <table class="tableForm">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left">
                                  <asp:CheckBox ID="chkapproremyes" runat="server" OnClick="enableTextBox1()" ControlsToDisable="" ControlsToEnable="" FolderStyle="" ParentCheckBoxID="" State="Unchecked" />                                    
                                </td>
                                <td>
                                ...
                                <td style="text-align: left;">
                                    <asp:CheckBox ID="chkDeliver" runat="server" OnClick="enableSLA()" ControlsToDisable="" ControlsToEnable="" FolderStyle="" ParentCheckBoxID="" State="Unchecked" />
                                </td>
                            </tr>
                            <tr>
                                 <td>
                                ...
                                <td style="text-align: left">
                                   <asp:CheckBox ID="chkecommerce" runat="server" ControlsToDisable="" ControlsToEnable="" FolderStyle="" ParentCheckBoxID="" State="Unchecked" onclick="CheckEcommerce()" />
                            ...
                            <tr>
                                ...
                                <td style="text-align: left">
                                   <asp:CheckBox ID="chkpricechange" runat="server" ControlsToDisable="" ControlsToEnable="" FolderStyle="" ParentCheckBoxID=""  onclick=" RemoveFA()" />
                                </td>
                                ...
                                <td style="text-align: left;">
                                 ...
                                 &nbsp;&nbsp;&nbsp;&nbsp;</td>
                                  <td>
                                    <req><asp:Label ID="lbllocation" runat="server" Text="Location Compulsory"></asp:Label>:</req>
                                  </td>
                                 <td style="text-align: left">
                                  <obout:OboutRadioButton ID="radiolocationNo" runat="server" Checked="True" GroupName="Location" Text="No" FolderStyle="">
                                    </obout:OboutRadioButton>
                                    <obout:OboutRadioButton ID="radiolocationYes" runat="server" GroupName="Location" Text="Yes" FolderStyle="">
                                    </obout:OboutRadioButton>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                     ...
                                     <asp:Label ID="lblTime" runat="server" Text="Ecommerce Time"></asp:Label>
                                    :
                                </td>
                                <td style="text-align: left">
                                 <asp:TextBox ID="txtelapseTime" Enabled="False" Width="70px" runat="server" Style="text-align: right"  MaxLength="20" Text="0"
                                         onkeypress="return fnAllowDigitsOnly(event)"></asp:TextBox>-
                                 <asp:TextBox ID="txtPreorderTime" Enabled="False" Width="70px" runat="server" Style="text-align: right" MaxLength="20" Text="0"
                                         onkeypress="return fnAllowDigitsOnly(event)"></asp:TextBox>  
                                </td>
                               <td>
                                   <asp:Label ID="lblRequestor" runat="server" Text="Ecommerce Requestor"></asp:Label>
                                    :
                                </td>
                                <td style="text-align: left;">
                                  <asp:TextBox ID="txtecomReq" Enabled="False" runat="server" MaxLength="50" Width="220px"></asp:TextBox>
                                  <img id="imgsearchRequest" src="../App_Themes/Grid/img/search.jpg" title="Search SKU" runat="server" style="cursor: pointer;" onclick="openRequestor('0')" />
                                 &nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td>
                                      <asp:Label ID="lblmerchant" runat="server" Text="Merchant Code"></asp:Label>:
                                </td>
                                 <td style="text-align: left;">
                            ...
                            <tr>
                                <td></td>
                                <td style="text-align: left">
                                    <asp:Label ID="lblnormalOrder" runat="server" Text="NormalOrder"></asp:Label>&nbsp;&nbsp;
                                   <asp:Label ID="lblpreorder" runat="server" Text="PreOrder"></asp:Label>  
                                </td>
                                 <td>
                                     <asp:Label ID="lblcustanalytics" runat="server" Text="Customer Analytics"></asp:Label> :
                                 </td>
                                <td style="text-align: left">
                                     <obout:OboutRadioButton ID="radioCustanalyticsyes" runat="server"  GroupName="Customer" Text="Yes" FolderStyle="">
                                    </obout:OboutRadioButton>
                                    <obout:OboutRadioButton ID="radiocustanalycsno" runat="server" Checked="True" GroupName="Customer" Text="No" FolderStyle="">
                                    </obout:OboutRadioButton>
                                </td>
                                <td>
                                    <asp:Label ID="lblmoney" runat="server" ClientIDMode="Static" Text="E Money" />
                                </td>
                                <td style="text-align:left">
                                   <obout:OboutCheckBox ID="chkemoney" runat="server"  />
                                </td>
                                <td style="text-align: left;">
                            ...
                            <tr>                               
                                <td align="left">
                                    <asp:Label ID="lblautoapprove" runat="server" ClientIDMode="Static" Text="ERP Auto Approval" />
                                </td>
                                <td style="text-align:left">
                                   <obout:OboutCheckBox ID="chkautoapprove" runat="server"  />
                                </td>
                               <td align="left">
                                    <asp:Label ID="lblexpiry" runat="server" ClientIDMode="Static" Text="Expiry Days" />
                                </td>                                                                                              
                                <td>
                                     <asp:TextBox ID="txtexpirydays" Enabled="true" runat="server" MaxLength="50" Width="220px"></asp:TextBox>
                                </td>                                                         
                                <td></td>  
                                <td></td>
                                <td style="text-align: left;">
                            ...
                            <tr>
                                <td>                                 
                                    <obout:Grid ID="Grid1" runat="server" AllowAddingRecords="False" AllowFiltering="True"
                                        AllowGrouping="True" AutoGenerateColumns="False" Width="100%" PageSize="25" OnRebind="Grid1_Rebind" >                       
                                        ...
                                        <Templates>
                                            <obout:GridTemplate runat="server" ID="GridTemplate1" ControlID="" ControlPropertyName="">
                                                <Template>
                                            ...
                                            <obout:GridTemplate runat="server" ID="GridTemplate2" ControlID="" ControlPropertyName="">
                                                <Template>
            ...
            <asp:TabPanel ID="tabSatutoryInfo" runat="server" HeaderText="Cost Center">
                <ContentTemplate>
                    <center>
                        <table class="tableForm">
                            <tr>
            ...
            <asp:TabPanel ID="tabAccountHistory" runat="server" HeaderText="Account Details">
               ...
               <asp:TabPanel ID="tabsftp" runat="server" HeaderText="SFTP Details">
                     <ContentTemplate>
                    <center>
                           <table class="gridFrame" width="70%">
                            <tr>
                                <td>
                                    <table style="width: 100%">
                                        <tr>
                                            <td style="text-align: left;">
                                                <a style="color: white; font-size: 15px; font-weight: bold;">
                                                    <asp:Label ID="lblftp" runat="server" Text="SFTP Details"></asp:Label></a>
                            ...
                            <tr>
                                <td>
                                    <obout:Grid ID="Gridsftp" runat="server" AllowAddingRecords="false" AllowFiltering="true"
                                        AllowGrouping="true" AutoGenerateColumns="false" Width="100%">
                                        <Columns>
                                           
                                            <obout:Column DataField="DeptName" HeaderText="Company Name" Visible="false" >
                                            </obout:Column>
                                             <obout:Column DataField="UserId" HeaderText="User Id" Width="25%" >
                                            </obout:Column>
                                            <obout:Column DataField="Password" HeaderText="Password" Width="25%" >
                                            </obout:Column>
                                            <obout:Column DataField="FolderPath" HeaderText="Folder Path" Width="40%" >
                                            </obout:Column>
                                            <obout:Column DataField="ConfigHour" HeaderText="Config Hour" Width="10%" >
                                            </obout:Column>
                                        </Columns>
    ...
    <script type="text/javascript">
        ...
        function Checkvalidations() {
            ...
            var sourceemail = document.getElementById("<%=txtsourceEmail.ClientID %>");
            ...
            if (!filter.test(sourceemail.value)) {
                showAlert("Please Enter Valid source Email Id!", "error", "#");
                document.getElementById("<%=txtsourceEmail.ClientID %>").focus();
                return false;
            }
        ...
        function CheckDeptvalidations() {
            ...
            if (document.getElementById("<%= chkpricechange.ClientID %>").checked == true) {
                var txtfa = document.getElementById("<%=txtbomsku.ClientID %>").value;
                if (txtfa == "") {
                    showAlert("Please Add Financial Approval!", "error", "#");
                    document.getElementById("<%=txtautoremsche.ClientID %>").focus();
                    return false;
                }
            }
            if (document.getElementById("<%= chkecommerce.ClientID %>").checked == true) {
                var txtrequestor = document.getElementById("<%=txtecomReq.ClientID %>").value;
                if (txtrequestor == "") {
                    showAlert("Please Add ECommerce Requestor!", "error", "#");
                    document.getElementById("<%=txtautoremsche.ClientID %>").focus();
                    return false;
                }
            }
    ...
    <script type="text/javascript">
        ...
        {
            if (document.getElementById("<%= chkecommerce.ClientID %>").checked == false) {
                document.getElementById("<%=txtelapseTime.ClientID %>").value = 0;
                document.getElementById("<%=txtelapseTime.ClientID %>").disabled = true;
                document.getElementById("<%=txtPreorderTime.ClientID %>").value = 0;
                document.getElementById("<%=txtPreorderTime.ClientID %>").disabled = true;
                document.getElementById("<%=radioCustanalyticsyes.ClientID %>").disabled = true;
                var Requestor = document.getElementById("<%=txtecomReq.ClientID %>").value; 
                if (Requestor != "")
                {
                    if (confirm('Are you sure to remove Ecommerce,Time & Ecommerce Requestor')) {
                        document.getElementById("<%=txtelapseTime.ClientID %>").value = 0;
                        document.getElementById("<%=txtPreorderTime.ClientID %>").value = 0;
                        document.getElementById("<%=txtecomReq.ClientID %>").value = "";
                        document.getElementById("<%=hdnRequestorID.ClientID %>").value = "";
                   }
                    else {
                        var chkecomm = document.getElementById("<%= chkecommerce.ClientID %>");
                        chkecomm.checked = true;
                        document.getElementById("<%=txtelapseTime.ClientID %>").value = 5;
                        document.getElementById("<%=txtPreorderTime.ClientID %>").value = 5;
                        document.getElementById("<%=txtelapseTime.ClientID %>").disabled = false;
                        document.getElementById("<%=txtPreorderTime.ClientID %>").disabled = false;
                    }
                }
        ...
        function openRequestor()
        {
            if (document.getElementById("<%=chkecommerce.ClientID %>").checked == true) {
                var deptid = document.getElementById("<%=hdnSelectedDepartment.ClientID %>").value;
                 window.open('../Account/RequestorList.aspx?deptid=' + deptid + "", null, 'height=700px, width=825px,status= 0, resizable= 1, scrollbars=1, toolbar=0,location=center,menubar=0, screenX=300; screenY=50');
             }
             else {
                 showAlert("Please Check on ECommerce !", "error", "#");
             }
        }
        function AfterRequestorSelect(Name, RequestorId) {
            var RequestorName = document.getElementById("hdnRequestorName");
            var RequestorID = document.getElementById("hdnRequestorID");
            RequestorName.value = Name;
            RequestorID.value = RequestorId;
            var TxtProduct = document.getElementById("<%=txtecomReq.ClientID %>");
            ...
            if (document.getElementById("<%= chkpricechange.ClientID %>").checked == false) {
                ...
                if (txtfa != "") {
                    if (confirm('Are you sure to remove Price & Financial Approver?')) {
                        ...
                        var chk = document.getElementById("<%= chkpricechange.ClientID %>");
                        chk.checked = true;
                    }
                }
            }
