    ...
    public partial class ApprovalLevelMaster : System.Web.UI.Page
    {
        ...
        protected void gvApprovalLevelM_Select(object sender, Obout.Grid.GridRecordEventArgs e)
        {
            try
            {
                ...
                //code change by suraj show radio button value
                iApprovalLevelMasterClient ApprovalClient = new iApprovalLevelMasterClient();
                string ApproverLogic = ApprovalClient.GetApprovalLevelApproverLogicvalue(Convert.ToInt64(hdnApprovalID.Value), profile.DBConnection._constr);
            ...
            try
            {
                ...
                {                    
                    ...
                    else
                    {
                        ...
                        ObjApprovalDetail.LastModifiedDate = today;
                        //add by suraj 
                        if (chkand.Checked == true)
                        { ObjApprovalDetail.ApproverLogic = "AND"; }
                        else
        ...
        public static void WMRemoveUserFromUserList(string ID)
        {
            ...
            try
            {
                ApprovalClient.DeleteApproverFromGrid(Convert.ToInt64(ID), profile.Personal.UserID,profile.DBConnection._constr);
