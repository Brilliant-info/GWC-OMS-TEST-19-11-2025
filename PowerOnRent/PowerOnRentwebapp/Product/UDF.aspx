<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UDF.aspx.cs" Inherits="PowerOnRentwebapp.Product.UDF" Theme="Blue" %>
                    ...
                    <td style="background-color: White;" colspan="2" align="center">
                        <table class="tableForm">
                            <tr>
                                ...
                                <td>
                                     <asp:TextBox ID="txtudf" runat="server"  Width="200px" Enabled="false"></asp:TextBox>
                                </td>
                                <td>
