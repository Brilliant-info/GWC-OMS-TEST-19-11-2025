<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM.Master" AutoEventWireup="true" CodeBehind="VSkuStockImport.aspx.cs" 
    Inherits="PowerOnRentwebapp.Product.VSkuStockImport" Theme="Blue" %>
                    ...
                    <table cellpadding="0" width="100%" cellspacing="5px" border="0" class="tableForm">
                        <tr>
                            <td style="text-align :left" colspan="4">
                                     ...
                                     <asp:Label ID="lbltext1" runat="server" Font-Size="14px" Text="Import will faciliated Virtual SKU Stock to be directly imported into OMS."></asp:Label>
                                   <%-- <span style="font-size:14px;"> Import will faciliated Order Data to be directly imported into OMS.</span><br />--%>
                                    <asp:Label ID="Lbl" runat="server" Font-Size="14px" Text="For Downloading Virtual SKU Stock Import Data Template"></asp:Label>
                                    <%--<a href="DirectOrderImport.xlsx" id="downloadlink" runat="server" target="_blank"><font color="blue"><u>Click Here.--%>

                                    <a href="VirtualStockImport template.xlsx" id="downloadlink" runat="server" target="_blank"><font color="blue"><u>Click Here.
            ...
            <tr>
                <td colspan="3">                                                                                        <%-- OnRowDataBound="GVImportView_OnRowDataBound"--%>
                        ...
                        <Columns>
                            ...
                            <obout:Column DataField="SKUCode" HeaderText="SKU Code" HeaderAlign="left" Align="left" Width="9%"> </obout:Column>
                            <obout:Column DataField="DepartmentCode" HeaderText="Department Code" HeaderAlign="left" Align="left" Width="9%"> </obout:Column>
                            <obout:Column DataField="VirtualQty" HeaderText="Virtual Sku Qty" HeaderAlign="Center" Align="right" Width="4%"> </obout:Column>
                             <obout:Column DataField="skuchk" HeaderText="skuchk" HeaderAlign="center" Align="left" Width="1%" Visible="false"> </obout:Column>
                             <obout:Column DataField="ProdDeptChk" HeaderText="ProdDeptChk" HeaderAlign="center" Align="left" Width="1%" Visible="false"> </obout:Column>
                             ...
                             <obout:Column DataField="Prodtypechk" HeaderText="Prodtypechk" HeaderAlign="left" Align="left" Width="1%" Visible="false"></obout:Column>
