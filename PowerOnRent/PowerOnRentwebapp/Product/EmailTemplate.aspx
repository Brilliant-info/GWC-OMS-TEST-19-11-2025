<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="EmailTemplate.aspx.cs" Inherits="PowerOnRentwebapp.Product.EmailTemplate" %>
    ...
    <asp:UpdatePanel ID="UpdatePanelTabPanelProductList" runat="server">
        <ContentTemplate>
            ...
            <asp:TabContainer runat="server" ID="TabContainerProductMaster" ActiveTabIndex="4">
                <asp:TabPanel ID="TabPanelProductList" runat="server" HeaderText="Email Template List">
                    <ContentTemplate>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lblrolllist" Style="color: white; font-size: 15px; font-weight: bold;"
                                                                runat="server" CssClass="headerText" Text="Email Template List" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                ...
                                                <obout:Grid ID="gvUserCreationM" runat="server" AllowAddingRecords="False" AllowFiltering="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <obout:Column DataField="MailSubject" HeaderText="MailSubject" Width="5%" Visible="false">
                                                         ...
                                                         <obout:Column DataField="Language" HeaderText="Language" Width="5%" Visible="false">
                                                        </obout:Column>
                                                    </Columns>
                                                    <Templates>
                                ...
                                <center>
                                    <table class="tableForm">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" style="text-align: left;">
                                                <asp:TextBox ID="txtSubject" runat="server" Width="585px"></asp:TextBox>
