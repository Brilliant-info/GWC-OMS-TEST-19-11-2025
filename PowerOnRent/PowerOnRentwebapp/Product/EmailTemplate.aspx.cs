...
namespace PowerOnRentwebapp.Product
{
    public partial class EmailTemplate : System.Web.UI.Page
    {
        ...
        {
            CustomProfile profile = CustomProfile.GetProfile();
            ProductCategoryService.iProductCategoryMasterClient TemplateClient = new ProductCategoryService.iProductCategoryMasterClient();
            try
            {
        ...
        {
            ProductCategoryService.iProductCategoryMasterClient ActivityList = new ProductCategoryService.iProductCategoryMasterClient();
        ...
        {
            ProductCategoryService.iProductCategoryMasterClient MessageList = new ProductCategoryService.iProductCategoryMasterClient();
        ...
        protected void gvUserCreationM_Select(object sender, Obout.Grid.GridRecordEventArgs e)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(selectedrec["Language"].ToString()))
                {
                    ddllanguage.SelectedValue = "English";
                }
                else
                {
                    ddllanguage.SelectedIndex = ddllanguage.Items.IndexOf(ddllanguage.Items.FindByValue(selectedrec["Language"].ToString()));
                }
