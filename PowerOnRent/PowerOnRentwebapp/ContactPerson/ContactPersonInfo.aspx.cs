...
namespace PowerOnRentwebapp.ContactPerson
{
    public partial class ContactPersonInfo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["TargetObject"] != null) TargetObject = Request.QueryString["TargetObject"].ToString() + "_ContactPerson";
        ...
        protected void GetRecordFromTempDataBySequenceID(string SequenceNo)
        {
            ...
            try
            {
                ...
                if (SequenceNo != "0")
                {
                    ...
                    CustomProfile profile = CustomProfile.GetProfile();
                    ContactPerson = ContactPersonClient.GetContactPersonTempDataBySequence(Convert.ToInt64(SequenceNo), sessionID, TargetObject, profile.Personal.UserID.ToString(), profile.DBConnection._constr);
        ...
        public static void PMSaveConatctPerson(object ContactPersonInfo)
        {
            ...
            try
            {
                ...
                {
                    ContactPersonList = ContactPersonClient.GetContactPersonTempDataBySequence(Convert.ToInt64(Sequence), sessionID, TargetObject, profile.Personal.UserID.ToString(), profile.DBConnection._constr);
               ...
               // ContactPersonList.Designation = rec["Designation"].ToString();
                ...
                // ContactPersonList.CompanyID = profile.Personal.CompanyID;     companyID
                ...
                { ContactPersonClient.SetValuesToTempData_onChange(sessionID, profile.Personal.UserID.ToString(), TargetObject, Convert.ToInt32(Sequence), ContactPersonList, profile.DBConnection._constr); }
                else
                { ContactPersonClient.InsertIntoTemp(ContactPersonList, sessionID, profile.Personal.UserID.ToString(), TargetObject, profile.DBConnection._constr); }
