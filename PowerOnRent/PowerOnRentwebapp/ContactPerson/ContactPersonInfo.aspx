<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactPersonInfo.aspx.cs" Inherits="PowerOnRentwebapp.ContactPerson.ContactPersonInfo" EnableEventValidation="false" %>
                        ...
                        <table class="tableForm">
                            <tr>
                                ...
                                <td>
                                 ...
                                 <td>
                                    <asp:Label ID="lbldeptc" runat="server" Text="Department"/> :
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddldepartment" DataTextField="Territory" DataValueField="ID"
                           ...
                           <%-- <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtremark" runat="server" Width="190px" MaxLength="200"></asp:TextBox>
                                </td>
         ...
         function SubmitContactPerson() {
             ...
             if (Page_IsValid) {
                 ...
                 { alert("Enter atleast one contact info \n[ EmailID / Office No. / Mobile No.]"); document.getElementById("txtEmailID").focus(); }
                     ...
                     ContactPersonInfo.Department = document.getElementById("ddldepartment").value;
                     ContactPersonInfo.hdncompanyid = document.getElementById("hdncompanyid").value; 
                     ContactPersonInfo.Designation = ddldepartment.options[ddldepartment.selectedIndex].text;
