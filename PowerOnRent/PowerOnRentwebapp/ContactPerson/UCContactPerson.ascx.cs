    ...
    public partial class UCContactPerson : System.Web.UI.UserControl
    {
        ...
        public void FillContactPersonByObjectNameReferenceID(string SourceObjectName, long ReferenceID, string TargetObjectName)
        {
            try
            {
                ...
                CustomProfile profile = CustomProfile.GetProfile();
                ServiceContactPersonInfo.iContactPersonInfoClient ServiceContactPerson = new ServiceContactPersonInfo.iContactPersonInfoClient();
        ...
        public static void ClearContactPerson(string ObjectName, string SessionID)
        {
            CustomProfile profile = CustomProfile.GetProfile();
            ServiceContactPersonInfo.iContactPersonInfoClient ServiceContactPerson = new ServiceContactPersonInfo.iContactPersonInfoClient();
            ServiceContactPerson.ClearTempDataFromDB(SessionID, profile.Personal.UserID.ToString(), "_ContactPerson", profile.DBConnection._constr);
            ServiceContactPerson.Close();
        }
        ...
        public void ClearContactPerson(string ObjectName)
        {
            ...
            CustomProfile profile = CustomProfile.GetProfile();
            ServiceContactPersonInfo.iContactPersonInfoClient ServiceContactPerson = new ServiceContactPersonInfo.iContactPersonInfoClient();
            ServiceContactPerson.ClearTempDataFromDB(Session.SessionID, profile.Personal.UserID.ToString(), "_ContactPerson", profile.DBConnection._constr);
            ServiceContactPerson.Close();
        }
